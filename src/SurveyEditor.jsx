...
const API_URL = 'https://script.google.com/macros/s/AKfycbzQCrKRX7nJgryTPsP2Aceh4_Ofyef2Ez2iBmHUGBYF3K15XYZk-5Na8XDIlLCqlAGtVQ/exec';
const SurveyEditor = () => {
  // === 設定 ===
  const [formBaseUrl, setFormBaseUrl] = useState(
    'https://docs.google.com/forms/d/e/1FAIpQLSfK29rSSrvSjt7onYIO5gDCLDhtj776z-EhKfTxf2gUlGPBlQ/viewform'
  );
  const [entryId, setEntryId] = useState('2029535182');
          ...
          <table className="w-full text-base mb-2 border-collapse">
            <tbody>
              ...
              <tr>
                ...
                <td className="py-1" colSpan="2">
                  <div className="flex items-center">
                    <span className="font-medium min-w-[13em]">兄弟に糖尿病歴はありますか？</span>
                    <div className="flex gap-8">
                      <span>□ はい</span>
                      <span>□ いいえ</span>
                      <span>□ わからない</span>
              ...
              <tr>
                ...
                <td className="py-1" colSpan="2">
                  <div className="flex items-center">
                    <span className="font-medium min-w-[13em]">両親に糖尿病歴はありますか？</span>
                    <div className="flex gap-8">
                      <span>□ はい</span>
                      <span>□ いいえ</span>
                      <span>□ わからない</span>
              ...
              <tr>
                ...
                <td className="py-1" colSpan="2">
                  <div className="flex items-center">
                    <span className="font-medium min-w-[13em]">普段、運動をしてますか？</span>
                    <div className="flex gap-6">
                      <span>□ ほぼ毎日</span>
                      <span>□ 週2～3回</span>
                      <span>□ 週1回以下</span>
